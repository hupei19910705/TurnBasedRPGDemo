...
public class BattleController : MonoBehaviour
{
    ...
    public CharactersData GetCharacterDatas(string s )
	{
		...
		return MainSimple.CharacterList.Where (w => w.Name == s.Replace(Settings.CloneName,"" ) ).FirstOrDefault ();
    ...
    void PositionPlayers()
	{
		try
		{
			...
			int calculatedPosition = y;
			foreach (var character in MainSimple.CharacterList)
			{
				y--;
				calculatedPosition = calculatedPosition - SpaceBetweenCharacters;
	...
	{
		MainSimple.ControlsBlocked = false;
