...
/// </summary>
[Serializable ()]
public class MainSimple : MonoBehaviour,ISerializable		
{
    /// <summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="MainSimple"/> class.
    /// </summary>
    public MainSimple (){}
    /// <summary>
    /// Initializes a new instance of the <see cref="MainSimple"/> class.
    ...
    public MainSimple (SerializationInfo info, StreamingContext context)
	{
...
#pragma warning disable
        MainSimple data = new MainSimple ();
#pragma warning restore 
    ...
    public static void Load () {
		...
		if (!string.IsNullOrEmpty (MainSimple.CurrentScene))
			SceneManager.LoadScene (MainSimple.CurrentScene);
		else
